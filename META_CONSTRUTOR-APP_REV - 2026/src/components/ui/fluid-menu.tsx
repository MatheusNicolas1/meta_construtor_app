    ...
    <div className="relative inline-block text-left">
      ...
      {isOpen && (
        <div
          ...
          } mt-2 w-56 rounded-md bg-card shadow-lg ring-1 ring-border ring-opacity-9 focus:outline-none z-50`}
          role="menu"
  ...
  return (
    <div className="relative w-[64px]" data-expanded={isExpanded}>
      ...
      <div className="relative">
        ...
        <div 
          className="relative w-16 h-16 bg-card cursor-pointer rounded-full group will-change-transform z-50 border border-border"
        ...
        {childrenArray.slice(1).map((child, index) => (
          <div 
            key={index} 
            className="absolute top-0 left-0 w-16 h-16 bg-card will-change-transform border border-border"
            style={{
