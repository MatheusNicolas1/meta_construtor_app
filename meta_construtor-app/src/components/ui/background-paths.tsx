        ...
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-background">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
                ...
                >
                    ...
                    >
                        Mais controle, menos retrabalho, obras na palma da mão.
                    </motion.p>
                    ...
                    <motion.div
                        ...
                        className="inline-block group relative bg-white/10 
                    ...
                    >
                        <Button
                            ...
                            bg-white hover:bg-primary text-black hover:text-white border-white 
                            transition-all duration-300 group-hover:-translate-y-0.5 hover:shadow-lg"
                        >
