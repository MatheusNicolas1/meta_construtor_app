...
import ImpactMetrics from '@/components/sobre/ImpactMetrics';
import { 
  Target, 
  Eye, 
  Heart,
...
const Sobre = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background w-full page-sobre">
        <section className="page-first-section pt-32 pb-16 md:pt-40 md:pb-24 lg:py-20 bg-gradient-to-br from-primary/10 via-background to-secondary/5 relative overflow-hidden">
          ...
          {/* CTA Final */}
          <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-r from-primary/10 via-primary/5 to-background">
