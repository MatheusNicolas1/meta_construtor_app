    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Button asChild className="bg-meta-orange hover:bg-meta-orange/90">
          <Link to="/app/projects/new" className="flex items-center gap-2">
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem className="cursor-pointer">
                          <Link to="/app/rdos/new" className="flex items-center">
                  ...
                  <div className="mt-6 flex justify-between items-center">
                    ...
                    <Button asChild size="sm" variant="outline">
                      <Link to={`/app/projects/${project.id}`}>Ver detalhes</Link>
                    </Button>
                  </div>
                </div>
              </CardContent>
